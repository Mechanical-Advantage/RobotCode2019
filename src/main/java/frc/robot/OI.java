...
public class OI {
  ...
  // private Trigger armCargoShipPlate
  // = new ButtonNotTrigger(armCargoShip, armAlt);
  // private Trigger armCargoShipCargo
  // = new MultiButtonTrigger(armCargoShip, armAlt);
  // private Trigger armRocketLowPlate
  // = new ButtonNotTrigger(armRocketLow, armAlt);
  // private Trigger armRocketLowCargo
  // = new MultiButtonTrigger(armRocketLow, armAlt);
  // private Trigger armRocketMidPlate
  // = new ButtonNotTrigger(armRocketMid, armAlt);
  // private Trigger armRocketMidCargo
  // = new MultiButtonTrigger(armRocketMid, armAlt);
  // private Trigger armRocketHighPlate
  // = new ButtonNotTrigger(armRocketHigh, armAlt);
  // private Trigger armRocketHighCargo
  // = new MultiButtonTrigger(armRocketHigh, armAlt);
  // private Trigger armHome
  // = new ButtonNotTrigger(armHomeBackward, armAlt);
  // private Trigger armLoadingBackward
  // = new MultiButtonTrigger(armHomeBackward, armAlt);
  ...
  public OI() {
    ...
    // SetArmPositions(ArmPosition.ROCKET_HI_CARGO));
    // armHome.whenActive(new
    // SetArmPositions(ArmPosition.HOME));
    // armLoadingBackward.whenActive(new
