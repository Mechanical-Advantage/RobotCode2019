...
public class DriveTrain extends Subsystem {
	...
	/*
	 * Talon SRX Unit Notes: Firmware in Phoenix does not support scaling
	 * 
	 * CTRE Mag Encoder Relative: 4096 ticks/native units per rotation Conversion
	 * factor: 6.8266 native units/100ms = 1rpm (for encoder with 4096 ticks only)
	 * 
	...
	/*
	 * Talon Slots: 0: Velocity Low Gear 1: Velocity High Gear 2: Motion
	 * profiling/magic 3: PTO Position Low gear used on single speed robots
	 */
