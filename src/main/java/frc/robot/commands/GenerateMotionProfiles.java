...
/**
 * Generates a set of motion profiles and saves them to a file for the auto
 * sequences
 */
public class GenerateMotionProfiles extends InstantCommand {
	...
	// ex: private static final double switchCenterDistance = 168; // Distance from
	// wall to center of switch
	...
	private void defineWaypoints() {
		// ex: sideStart = new Waypoint(RobotMap.robotLength/2,
		// 132-RobotMap.robotWidth/2, 0);
	}
	...
	protected void initialize() {
		...
		// these waypoints should be defined assuming the right side of the field, auto
		// flipped on left
		...
		// Trajectory.Config.SAMPLES_HIGH, 0.05, /*124.4*/120, /*62.2,41.4*/55,
		// /*1866*/2700);
		// points = new Waypoint[] {
		// new Waypoint(0, 0, 0),
