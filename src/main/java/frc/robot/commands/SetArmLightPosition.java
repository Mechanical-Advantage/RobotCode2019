...
public class SetArmLightPosition extends Command {
  ...
  protected boolean isFinished() {
    return Math.abs(Robot.armLight.getElbowPosition() - Robot.armLight.getElbowTargetPosition()) <= endTolerance;
  }
  ...
  public enum ArmLightPosition {
    ROCKET_MID_PLATE, ROCKET_MID_CARGO, ROCKET_LO_PLATE, ROCKET_LO_CARGO, CARGOSHIP_PLATE, CARGOSHIP_CARGO, FLOOR_CARGO,
    LOADING_CARGO, LOADING_PLATE, HOME, UP, CAMERA;

    private static final Map<ArmLightPosition, Boolean> shoulderMap = Map.ofEntries(Map.entry(ROCKET_MID_PLATE, false),
        Map.entry(ROCKET_MID_CARGO, false), Map.entry(ROCKET_LO_PLATE, false), Map.entry(ROCKET_LO_CARGO, false),
        Map.entry(CARGOSHIP_PLATE, false), Map.entry(CARGOSHIP_CARGO, false), Map.entry(FLOOR_CARGO, false),
        Map.entry(LOADING_CARGO, false), Map.entry(LOADING_PLATE, false), Map.entry(HOME, false), Map.entry(UP, false),
    ...
    private static final Map<ArmLightPosition, Double> elbowMap = Map.ofEntries(Map.entry(ROCKET_MID_PLATE, 110.0),
        Map.entry(ROCKET_MID_CARGO, 105.0), Map.entry(ROCKET_LO_PLATE, 155.0), Map.entry(ROCKET_LO_CARGO, 123.0), // good
        Map.entry(CARGOSHIP_PLATE, 155.0), Map.entry(CARGOSHIP_CARGO, 80.0), Map.entry(FLOOR_CARGO, 203.0), // good
        Map.entry(LOADING_CARGO, 90.0), // good
        Map.entry(LOADING_PLATE, 163.0), Map.entry(HOME, ArmLight.elbowStartingPosition), Map.entry(UP, 49.0),
