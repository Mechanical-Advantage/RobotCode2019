...
/**
 * Drive the specified distance on the specified heading Does not turn first,
 * really use it to drive straight Also is not good if the robot is strongly
 * knocked off course (like being kicked)
 */
